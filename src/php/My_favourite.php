...
function generate($row)
{
    ...
    <div class="row" >
        ...
        <div class="picture_introduce">
            ...
            <div class="operation" >
                <a href="My_favourite.php?delete=' . $row['ImageID'] . '"   onclick="return myClick();">
                   <img src="../../images/icon/delete.png" alt="Delete" class="icon">
                   </a>
                     <script type="text/javascript">
                     function myClick(){
                         return confirm("确定要从我的收藏里删除吗？");
                     }
</script>
            ...
            if (isset($_SESSION['id'])) {
                ...
                <div class ="Nav-right-menu">
                    <ul>
                        ...
                        <li><a href="My_favourite.php"  class="Nav-active"><i class="fa fa-heart"></i>My Favorite</a></li>
...
<div class="main-container">
    ...
    <?php
    if (isset($_SESSION['id'])) {
        $result = getFavorPhotoByUID($UID);
        $rowNumber = $result->rowCount();
        if ($rowNumber == 0) {
            echo '<div class="row">
    <p>你还没有收藏的照片，快去上传照片吧!</p>
    </div>';
        }
        global $pageNumber;
